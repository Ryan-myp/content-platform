...
def _video_templates():
    ...
    t, _ = _build(
        ...
        _outro("#1A1A1A", "星火优选", "关注我 · 更多海外好物", "#00F2EA", "#FF2E4D"),
    ...
    t, _ = _build(
        ...
        _outro("#5D2E00→#3A1C00", "星火优选", "更多超值套装 · 关注解锁", "#FFD93D", "#FF8A00"),
    ...
    t, _ = _build(
        ...
        _outro("#7A2545→#4A2545", "星火美妆", "关注 · 更多变美干货", "#FFD93D", "#FF6B9D"),
        {"mode": "once", "once": 10, "day": 5, "month": 49},
    ...
    t, _ = _build(
        ...
        _outro("#FFF9F2→#FFE8E8", "星火种草日记", "关注 · 每周一篇测评", "#FF2442", "#FF2442"),
        {"mode": "free", "once": 0, "day": 0, "month": 0},
    ...
    t, _ = _build(
        ...
        _outro("#0F172A→#0A0F1E", "星火旅行", "关注 · 每周一条线路", "#FDE68A", "#FDE68A"),
