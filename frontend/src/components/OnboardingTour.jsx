 ...
 * 步骤：平台概览 → 创作工厂 → 玩法工坊 → 个人中心与额度。
 */
const STEPS = [
  {
    title: '欢迎来到内容创作平台',
    desc: '一个本地免费运行的内容创作平台。左侧导航按「创作工厂 / 效率工具箱」组织，AI 费用由你配置的中转站 Key 计费，数据仅存本机。',
    icon: PartyPopper,
    color: 'from-brand-500 to-indigo-600',
  },
  {
    title: '创作工厂 · 一站式创作',
    desc: '图片、视频、音乐、文案、翻译、PPT 等工厂帮你搞定全部创作需求。按 ⌘K / Ctrl+K 可随时打开全局搜索，快速找到任何功能。',
    icon: Sparkles,
  ...
  {
    title: '玩法工坊 · 更多创作形态',
    desc: '除了图片视频，还能一键生成小游戏（网页+微信双版本）、表情包、短剧（题材模板+数字人播报）、音乐、小程序。所有作品自动保存历史，可随时复用、收藏、分享。',
    icon: Wrench,
    color: 'from-fuchsia-500 to-pink-600',
    target: '/games',
  },
  {
    title: '个人中心 · 额度与中转站 Key',
    desc: '本地版每天 30 次生成额度，点击左下角头像进入个人中心可查看剩余额度、修改资料密码、配置中转站 API Key；生成结果支持一键分享。',
    icon: UserCircle,
